...
def main():
    ...
    p_run = sub.add_parser("run-once", help="Fetch one company (BYND) and compute Condition 1")
    p_run.add_argument("--config", default="src/slidemodel/config/companies.yaml")
